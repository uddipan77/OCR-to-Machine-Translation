...
def get_few_shot_examples():
            ...
            content=[
                {
                    "type": "image_url",
                    "image_url": {
                        "url": image_file_to_base64(example3_img_path)
                    }
                }
            ]
        )
            ...
            content=[
                {
                    "type": "image_url",
                    "image_url": {
                        "url": image_file_to_base64(example6_img_path)
                    }
                }
            ]
        )
    ...
    examples.append(
        AIMessage(
            content=(
                ...
                # If you have the rest of the text, add it here!
            )
        )
    )

    # Example 9 (first)
    example9_img_path1 = r"E:\\Data\\output_train_img\\doc_00aff3757f87ebdfa666e19cda073e0d3a30943c.page_2.png"
    examples.append(
        HumanMessage(
            content=[
                {
                    "type": "image_url",
                    "image_url": {
                        "url": image_file_to_base64(example9_img_path1)
                    }
                }
            ]
        )
    ...
    # Example 9 (second)
    example9_img_path2 = r"E:\\Data\\output_train_img\\doc_00b5005717fb8925b94ecc069b9ad4954590f125.page_14.png"
    examples.append(
        HumanMessage(
            content=[
                {
                    "type": "image_url",
                    "image_url": {
                        "url": image_file_to_base64(example9_img_path2)
                    }
                }
            ]
        )
    ...
    # If you have more examples, just copy the above pattern and add them here.
